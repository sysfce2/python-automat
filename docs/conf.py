...
pydoctor_args = [
    ...
    "--intersphinx=https://graphviz.readthedocs.io/en/stable/objects.inv",
...
def _get_release() -> str:
    ...
    try:
        ...
        raise Exception("You must install Automat to build the documentation.")
...
latex_documents = [
    (master_doc, "automat.tex", "automat Documentation", "Glyph", "manual"),
]
...
man_pages = [(master_doc, "automat", "automat Documentation", [author], 1)]
